...
Use one profile name in the first message to an agent. The agent should then filter [../wcag/success-criteria.md](../wcag/success-criteria.md) to that column and ignore the rest.
...
| Official | [Revised 508 Standards E205.4](https://www.access-board.gov/ict/#E205-content); local [../section-508/revised-standards.md](../section-508/revised-standards.md) |
| Catalog filter | column **508-W** = Y |
| Also read | [../section-508/applicability-conformance.md](../section-508/applicability-conformance.md) |
...
| Official | [DOJ fact sheet](https://www.ada.gov/resources/2024-03-08-web-rule/); 28 C.F.R. Part 35; local [../ada/title-ii-web-mobile.md](../ada/title-ii-web-mobile.md) |
...
| Also recommended | [../cognitive/coga-usable.md](../cognitive/coga-usable.md) as advisory, not as a claim |
...
EU ICT (and several national adoptions). Current EN 301 549 uses **WCAG 2.1**; next version expected to use 2.2. Treat like `ada-title-ii` for web/software WCAG criteria, plus EN hardware/documentation clauses that are not in this library. Official PDF: see [../SOURCES.md](../SOURCES.md).
...
Details: [../wcag/whats-new-2.1.md](../wcag/whats-new-2.1.md), [../wcag/whats-new-2.2.md](../wcag/whats-new-2.2.md).

## What no profile replaces

- Keyboard testing, screen-reader testing, and users with disabilities ([../evaluation/wcag-em.md](../evaluation/wcag-em.md))
