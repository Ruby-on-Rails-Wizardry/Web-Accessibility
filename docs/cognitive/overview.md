...
2. **[Making Content Usable](https://www.w3.org/TR/coga-usable/)** (“Content Usable”) — W3C Working Group Note, 29 April 2021. Longer: aims, the same patterns, involving users, personas, user needs. Local: [coga-usable.md](coga-usable.md).
