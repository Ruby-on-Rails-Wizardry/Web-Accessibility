...
That is the opposite of dumping the full WCAG Recommendation into every prompt. See [../agents/reducing-cognitive-load.md](../agents/reducing-cognitive-load.md).
