...
>
> **Source:** [WCAG 2 at a Glance](https://www.w3.org/WAI/standards-guidelines/wcag/glance/) — W3C WAI
>
> **Normative specifications:** [WCAG 2.2](https://www.w3.org/TR/WCAG22/), [WCAG 2.1](https://www.w3.org/TR/WCAG21/)
>
> **Status:** Informative paraphrase at the **guideline** level. Success criteria are in the Recommendation and in [success-criteria.md](success-criteria.md).
>
> Copyright © World Wide Web Consortium. https://www.w3.org/copyright/document-license-2023/
>
> This software or document includes material copied from or derived from [WCAG 2 at a Glance](https://www.w3.org/WAI/standards-guidelines/wcag/glance/).

This is a paraphrased summary of WCAG 2.1 and 2.2. The guidelines are the same in 2.1 and 2.2. New success criteria are listed in [whats-new-2.2.md](whats-new-2.2.md).
...
- Do not use content that causes [seizures or physical reactions](https://www.w3.org/WAI/WCAG22/quickref/#seizures-and-physical-reactions).
...
## Differences in WCAG 2.0 at a Glance

[WCAG 2.0 at a Glance](https://www.w3.org/WAI/standards-guidelines/wcag/20/glance/) differs in two places:
