...
Section 508 also has ICT chapters (hardware, software interoperability, authoring tools, support, functional performance criteria) that are **not** WCAG criteria. See [../section-508/revised-standards.md](../section-508/revised-standards.md).
