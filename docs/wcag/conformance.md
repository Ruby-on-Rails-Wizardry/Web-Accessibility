# Understanding WCAG 2 conformance
...
GSA states the same for Section 508: a sequence does not conform if any step fails. See [../section-508/applicability-conformance.md](../section-508/applicability-conformance.md).
