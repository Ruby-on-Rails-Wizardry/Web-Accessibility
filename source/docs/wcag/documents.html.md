...
description: Standard vs Understanding vs Techniques vs ACT vs supplemental.
---
...
[WCAG 2.2](https://www.w3.org/TR/WCAG22/) is the stable, referenceable technical standard. Overview: [overview.md](overview/).
...
- [About Understanding](https://www.w3.org/WAI/WCAG22/Understanding/intro) — local: [understanding-intro.md](understanding-intro/)
...
- Local: [../cognitive/overview.md](../cognitive/overview/)

## Getting started (before WCAG)

- [Introduction to Web Accessibility](https://www.w3.org/WAI/fundamentals/accessibility-intro/)
- [Accessibility Principles](https://www.w3.org/WAI/fundamentals/accessibility-principles/) — local: [principles.md](principles/)
