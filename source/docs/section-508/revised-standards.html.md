---
title: Revised Section 508 Standards (ICT Refresh)
description: ICT Refresh; E205.4 incorporates WCAG 2.0 AA.
---
...
GSA: a page that fails even one of the 38 applicable WCAG 2.0 A/AA criteria does not conform. See [applicability-conformance.md](applicability-conformance/).
...
Authoring tools are in scope: not only word processors, but tools that produce web pages or applications, and IDEs. That is the 508 hook for **agents that generate UI**. Pair with [../authoring-tools/atag.md](../authoring-tools/atag/).
